class Game{
	constructor(canvas){
		...
		this.weapons = {
			...
			fasterBlaster: new Weapon('Faster Blaster',2,15,0.0000001,1,1,10,3),
			ionCannon: new Weapon('Ion Cannon',3,5,0.000001,3,2,20,15),
			ionBeam: new Weapon('Ion Beam',4,20,0.000001,1,2,5,2,true),
			particleShredder: new Weapon('Quark Shredder',5,15,Math.PI/8,5,2,10,1),
			bigBlaster: new Weapon('Big Blaster',7,10,0.000001,2,2,8,15,1),
			turboBoom: new Weapon('Turbo Boom',9,15,Math.PI/8,7,2,10,3,1),
			pBeam: new Weapon('P Beam',11,15,0.00001,1,2,1,1,1),
			ultimate: new Weapon('Ultimate',13,20,Math.PI/8,7,2,3,3,1),
		}
		this.waveTexts = [
